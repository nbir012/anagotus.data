...
Curculionidae) endemic to New Zealand. This package provides a dataset of
label data for *Anagotus* specimens housed in museum collections in New
Zealand and overseas, including temporal and spatial information where
available.
...
and species identifications. See `?df_anagotus` for full documentation of
all variables.

## Data sources

- Specimen label data digitised by Neil Birrell from museum collections in
