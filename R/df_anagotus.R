...
#'   \item{decimal_latitude}{num The latitude in decimal degrees where the specimen was collected. This is often estimated from a place name.}
#'   \item{decimal_longitude}{num The longitude in decimal degrees where the specimen was collected. This is often estimated from a place name.}
...
#'   \item{day}{int The day the specimen was collected, if known.}
#' }
