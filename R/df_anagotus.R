...
#' \describe{
#'   \item{institution_code}{chr Code for the institution housing the specimen. Codes are:
...
#' researcher_digitised = data digitised by Neil Birrell from physical specimen labels in museum collections;
