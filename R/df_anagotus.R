...
#'
#' Anagotus is a genus of large, flightless weevils (Coleoptera: Curculionidae) endemic to New Zealand. The dataset contains label data for 1,487 Anagotus specimens located in museum collections in New Zealand and overseas. The variables are:  
#'
#' @format A tibble with 1,237 rows and 12 variables:
#' \describe{
